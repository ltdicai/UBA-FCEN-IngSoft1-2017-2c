...
class Numero:
    ...
    def sumarEntero(self, entero):
        self.shouldBeImplementedBySubclass()
        
    def multiplicarEntero(self, entero):
        self.shouldBeImplementedBySubclass()
        
    def sumarFraccion(self, fraccion):
        self.shouldBeImplementedBySubclass()
        
    def multiplicarFraccion(self, fraccion):
        self.shouldBeImplementedBySubclass()
...
class Entero(Numero):
    ...
    def sumarEntero(self, entero):
        return Entero(self._valor+entero.valor())
        
    def sumarFraccion(self, fraccion):
        return fraccion.sumarEntero(self)
        
    def multiplicarEntero(self, entero):
        return Entero(self._valor*entero.valor())
        
    def multiplicarFraccion(self, fraccion):
        return fraccion.multiplicarEntero(self)
        
    def dividirFraccion(self, dividendo):
        # dividendo / self donde dividendo es Fraccion
...
class Fraccion(Numero):
    ...
    def sumarEntero(self, entero):
        return (self._numerador + (self._denominador * entero)) / self._denominador
        
    def sumarFraccion(self, fraccion):
        nuevoDenominador = self._denominador * fraccion.denominador()
        primerSumando = self._numerador * fraccion.denominador()
        segundoSumando = self._denominador * fraccion.numerador()
        nuevoNumerador = primerSumando + segundoSumando
        
        return nuevoNumerador / nuevoDenominador
        
    def multiplicarEntero(self, entero):
        return (self._numerador * entero) / self._denominador
        
    def multiplicarFraccion(self, fraccion):
        return (self._numerador * fraccion.numerador()) / (self._denominador * fraccion.denominador())
        
    def dividirEntero(self, dividendo):
        # dividendo / self donde dividendo es Entero
